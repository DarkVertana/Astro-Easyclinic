...
const LONG_TAIL: LongTailMarket[] = [
	{
		...
		geo: 'Uganda',
		geoAdj: 'Ugandan',
		localPay: 'Cards, transfers; mobile money confirm in demo',
		complianceMeta: 'Local facility rules — confirm in demo',
		complianceNote: 'Local facility rules confirmed in demo; WhatsApp-first engagement.',
		complianceBullets: [
			'Local facility rules — confirm status in demo',
			'WhatsApp-first patient engagement',
			'Mobile money rails: confirm by plan in demo',
			'Role-based access, encryption, audit logs',
		],
	},
	{
		...
		complianceNote: 'Confirm status in demo — no checkbox claims.',
		complianceBullets: [
			'Confirm current controls in demo — no checkbox claims',
			'Mobile money rails: confirm by plan in demo',
	...
	},
	{
		...
		localPay: 'Cards, transfers; mobile money confirm in demo',
		complianceMeta: 'Local compliance — confirm in demo',
		complianceNote: 'Confirm status in demo.',
		complianceBullets: [
			'Confirm current controls in demo',
			'Mobile money rails: confirm by plan in demo',
			'WhatsApp / SMS patient reminders',
			'Role-based access, encryption, audit logs',
		],
	},
	{
		...
		geo: 'Ghana',
		geoAdj: 'Ghanaian',
		localPay: 'MTN MoMo, Vodafone Cash, AirtelTigo (MoMo roadmap), cards, cash',
		complianceMeta: 'Ghana compliance WIP; NHIS claim integration planned',
		complianceNote: 'Ghana compliance WIP — NHIS-compatible billing now; dedicated NHIA/NHIS claim integration planned (not live).',
		complianceBullets: [
			'Ghana compliance work in progress — confirm current status in demo',
			'NHIS-compatible billing workflows available now',
			'Dedicated NHIA/NHIS claim integration: planned (not live)',
			'MoMo rails (MTN / Vodafone / AirtelTigo): roadmap — confirm in demo',
			'Role-based access, encryption, audit logs',
		],
	},
	{
		...
		geo: 'Ethiopia',
		geoAdj: 'Ethiopian',
		localPay: 'Cards, transfers, cash — local rails confirm in demo',
		complianceMeta: 'Local compliance — offline mode confirm in demo',
		complianceNote: 'Offline/sync mode and language claims confirmed in demo — cloud-first honesty.',
		complianceBullets: [
			'Cloud-first EMR; any offline/sync mode confirmed in demo',
			'Amharic/English UI claims: verify current status in demo',
			'Local payment rails: confirm by plan in demo',
			'Role-based access, encryption, audit logs',
		],
	},
	{
		...
		complianceBullets: [
			'Confirm in demo — no invented regulator checkboxes',
			'Mobile money / transfers: confirm by plan in demo',
			'WhatsApp / SMS patient reminders',
			'Role-based access, encryption, audit logs',
		],
	},
	{
		...
		localPay: 'Cards, EFT, local gateways — confirm in demo',
		complianceMeta: 'POPIA privacy expectations — discuss in demo',
		complianceNote: 'POPIA privacy expectations — we discuss controls in demo; no certification claim.',
		complianceBullets: [
			'POPIA privacy expectations: discuss current controls in demo (no certification claim)',
			'Role-based access, encryption, audit logs',
	...
	},
	{
		...
		complianceBullets: [
			'Facility and MoPH needs — confirm status in demo',
	...
	},
	{
		...
		complianceMeta: 'Aasandha billing hygiene; offline/sync confirm in demo',
		complianceNote: 'Aasandha-oriented billing hygiene; island offline/sync mode confirmed in demo (no connector overclaim).',
		complianceBullets: [
			'Aasandha: clean, traceable billing hygiene — connector status confirmed in demo',
			'Offline/sync for island clinics: confirm current mode in demo',
			'Role-based access, encryption, audit logs',
			'WhatsApp / SMS patient reminders',
		],
	},
